...
namespace Allekslar\MonofonyDemoBackendBundle\MessageHandler;

use Allekslar\MonofonyDemoBackendBundle\Message\RegisterAppUser;
use Allekslar\MonofonyDemoBackendBundle\Provider\CustomerProviderInterface;
